      ...
      <div className="lg:w-3/5 xl:px-20">
        <div className="flex flex-col lg:gap-10">
          ...
          <div className="flex flex-row justify-between flex-wrap">
            ...
            <Readit />
            <BillyBully />
            <div className="flex flex-col justify-between xl:w-[32%] lg:w-[48%] aspect-3/4  border border-gray-400 p-3 rounded-xl shadow-xl lg:gap-7 hover:cursor-pointer hover:-translate-y-1 hover:scale-105 duration-300"></div>
          </div>
        </div>
      </div>
    </>
